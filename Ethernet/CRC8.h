...
#define __CRC8_H__
#include "stdint.h"
extern int check_fcs(uint8_t* p, uint8_t len, uint8_t offset, uint8_t received_fcs);
extern uint8_t get_crc8_ieee8023_epon(uint8_t* p, uint8_t len, uint8_t offset);
